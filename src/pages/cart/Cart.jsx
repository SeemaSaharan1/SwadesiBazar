...
function Cart() {
  ...
  const deleteCart = (item) => {
    ...
    toast.success("Deleted from cart", { autoClose: 1000 });
  };
  ...
  const buyNow = async () => {
    ...
    var options = {
      key: "rzp_test_znJmnXd5NlYo2a",
      key_secret: "yx0he3sbAfHk6FAXXcrytCLr",
        ...
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
          {cartItems.length === 0 ? (
            <div className="text-center w-full">
              <p className="text-lg">You have no items in your cart.</p>
            </div>
          ) : (
            <>
